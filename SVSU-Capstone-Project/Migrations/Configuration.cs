    ...
    internal sealed class Configuration : DbMigrationsConfiguration<InvDb>
    {
        ...
        protected override void Seed( InvDb context )
        {
            ...
            context.dsQuantities.AddOrUpdate(
                new Quantity() { uidTuid = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), intQuantity = 300, objCabinet = context.dsCabinets.First(x => x.strName == "Cabinet 1" && x.objRoom.strName == "HE 110"), objCommodity = context.dsCommodities.First(x => x.strName == "Non-Latex Gloves"), objNLevel = context.dsNLevels.First(x => x.strName == "1") },
                new Quantity() { uidTuid = new Guid("baaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), intQuantity = 500, objCabinet = context.dsCabinets.First(x => x.strName == "Cabinet 3" && x.objRoom.strName == "HE 111"), objCommodity = context.dsCommodities.First(x => x.strName == "Cotton Balls"), objNLevel = context.dsNLevels.First(x => x.strName == "1") },
                new Quantity() { uidTuid = new Guid("caaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), intQuantity = 500, objCabinet = context.dsCabinets.First(x => x.strName == "Cabinet 3" && x.objRoom.strName == "HE 110"), objCommodity = context.dsCommodities.First(x => x.strName == "Sterile Alchohol Prep Pad"), objNLevel = context.dsNLevels.First(x => x.strName == "1") },
                new Quantity() { uidTuid = new Guid("daaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), intQuantity = 80, objCabinet = context.dsCabinets.First(x => x.strName == "Cabinet 4" && x.objRoom.strName == "HE 230"), objCommodity = context.dsCommodities.First(x => x.strName == "Hypodermic Needles"), objNLevel = context.dsNLevels.First(x => x.strName == "2") },
                new Quantity() { uidTuid = new Guid("eaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), intQuantity = 80, objCabinet = context.dsCabinets.First(x => x.strName == "Cabinet 2" && x.objRoom.strName == "HE 240"), objCommodity = context.dsCommodities.First(x => x.strName == "Lock Syringes"), objNLevel = context.dsNLevels.First(x => x.strName == "2") },
                new Quantity() { uidTuid = new Guid("faaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), intQuantity = 2, objCabinet = context.dsCabinets.First(x => x.strName == "Cabinet 6" && x.objRoom.strName == "HE 110"), objCommodity = context.dsCommodities.First(x => x.strName == "CPR Manikin And AED Kit"), objNLevel = context.dsNLevels.First(x => x.strName == "1") },
                new Quantity() { uidTuid = new Guid("abaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), intQuantity = 4, objCabinet = context.dsCabinets.First(x => x.strName == "Cabinet 1" && x.objRoom.strName == "HE 314"), objCommodity = context.dsCommodities.First(x => x.strName == "IV Training Arm"), objNLevel = context.dsNLevels.First(x => x.strName == "3") },
                new Quantity() { uidTuid = new Guid("acaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), intQuantity = 5, objCabinet = context.dsCabinets.First(x => x.strName == "Cabinet 6" && x.objRoom.strName == "HE 327"), objCommodity = context.dsCommodities.First(x => x.strName == "OLED Fingertip Pulse Oximeter"), objNLevel = context.dsNLevels.First(x => x.strName == "3") },
                new Quantity() { uidTuid = new Guid("adaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), intQuantity = 3, objCabinet = context.dsCabinets.First(x => x.strName == "Floor Item" && x.objRoom.strName == "HE 400"), objCommodity = context.dsCommodities.First(x => x.strName == "MedVision Adult Patient Simulator"), objNLevel = context.dsNLevels.First(x => x.strName == "4") },
                new Quantity() { uidTuid = new Guid("aeaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), intQuantity = 3, objCabinet = context.dsCabinets.First(x => x.strName == "Floor Item" && x.objRoom.strName == "HE 515"), objCommodity = context.dsCommodities.First(x => x.strName == "MedVision Pediatric Patient Simulator"), objNLevel = context.dsNLevels.First(x => x.strName == "5") },
                new Quantity() { uidTuid = new Guid("afaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), intQuantity = 3, objCabinet = context.dsCabinets.First(x => x.strName == "Floor Item" && x.objRoom.strName == "HE 516"), objCommodity = context.dsCommodities.First(x => x.strName == "MedVision Infant Patient Simulator"), objNLevel = context.dsNLevels.First(x => x.strName == "5") },
                new Quantity() { uidTuid = new Guid("aabaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), intQuantity = 200, objCabinet = context.dsCabinets.First(x => x.strName == "Cabinet 2" && x.objRoom.strName == "HE 327"), objCommodity = context.dsCommodities.First(x => x.strName == "Venturi Oxygen Mask"), objNLevel = context.dsNLevels.First(x => x.strName == "3") },
                new Quantity() { uidTuid = new Guid("aacaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), intQuantity = 75, objCabinet = context.dsCabinets.First(x => x.strName == "Cabinet 2" && x.objRoom.strName == "HE 111"), objCommodity = context.dsCommodities.First(x => x.strName == "Medline Nonskid Polypropylene Shoe Covers"), objNLevel = context.dsNLevels.First(x => x.strName == "1") },
                new Quantity() { uidTuid = new Guid("aadaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), intQuantity = 200, objCabinet = context.dsCabinets.First(x => x.strName == "Cabinet 3" && x.objRoom.strName == "HE 111"), objCommodity = context.dsCommodities.First(x => x.strName == "Lightweight Polypropylene Isolation Gowns"), objNLevel = context.dsNLevels.First(x => x.strName == "1") },
                new Quantity() { uidTuid = new Guid("aaeaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), intQuantity = 300, objCabinet = context.dsCabinets.First(x => x.strName == "Cabinet 5" && x.objRoom.strName == "HE 110"), objCommodity = context.dsCommodities.First(x => x.strName == "N95 Particulate Respiratory and Surgical Mask"), objNLevel = context.dsNLevels.First(x => x.strName == "1") },
                new Quantity() { uidTuid = new Guid("aafaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), intQuantity = 3, objCabinet = context.dsCabinets.First(x => x.strName == "Floor Item" && x.objRoom.strName == "HE 516"), objCommodity = context.dsCommodities.First(x => x.strName == "Manual Exam Table"), objNLevel = context.dsNLevels.First(x => x.strName == "NP") }
            );
            ...
            context.dsLogs.AddOrUpdate(
                new Log() { uidTuid = new Guid("bbbbbbbb-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), enuAction = ItemAction.Added, dtTimestamp = DateTime.Now, strNotes = "Added 250 gloves", intQuantityChange = 250, objCommodity = context.dsCommodities.First(x => x.strName == "Non-Latex Gloves"), objUser = context.dsUsers.First(x => x.strSvsu_id == "500010") },
                new Log() { uidTuid = new Guid("cccccccc-cccc-cccc-cccc-cccccccccccd"), enuAction = ItemAction.Moved, dtTimestamp = DateTime.Now, strNotes = "Consumed 5 alchohol prep pads", intQuantityChange = 5, objCommodity = context.dsCommodities.First(x => x.strName == "Sterile Alchohol Prep Pad"), objUser = context.dsUsers.First(x => x.strSvsu_id == "500006") },
                new Log() { uidTuid = new Guid("dddddddd-dddd-dddd-dddd-dddddddddddd"), enuAction = ItemAction.CheckedOut, dtTimestamp = DateTime.Now, strNotes = "Checked out MedVision Adult Patient Simulator", intQuantityChange = 1, objCommodity = context.dsCommodities.First(x => x.strName == "MedVision Adult Patient Simulator"), objUser = context.dsUsers.First(x => x.strSvsu_id == "500003") }
            );
        }
    }
}
