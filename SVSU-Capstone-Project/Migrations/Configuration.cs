    ...
    internal sealed class Configuration : DbMigrationsConfiguration<InvDb>
    {
        ...
        protected override void Seed( InvDb context )
        {
            ...
            context.dsUsers.AddOrUpdate(
                new User() { uidTuid = new Guid("abaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), strSvsu_id = "500001", strFirst_name = "Alexander", strLast_name = "Buckstiegel", strEmail = "awbuckst@svsu.edu", strPhone = "", blnIsAdmin = true },
                new User() { uidTuid = new Guid("baaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), strSvsu_id = "500002", strFirst_name = "Ann", strLast_name = "Krause", strEmail = "aekrause@svsu.edu", strPhone = "", blnIsAdmin = true },
                new User() { uidTuid = new Guid("caaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), strSvsu_id = "500003", strFirst_name = "Ariel", strLast_name = "Taylor", strEmail = "aataylo3@svsu.edu", strPhone = "", blnIsAdmin = true },
                new User() { uidTuid = new Guid("daaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), strSvsu_id = "500004", strFirst_name = "Benjamin", strLast_name = "Neeb", strEmail = "brneeb@svsu.edu", strPhone = "", blnIsAdmin = true },
                new User() { uidTuid = new Guid("eaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), strSvsu_id = "500005", strFirst_name = "Brett", strLast_name = "Previdi", strEmail = "bcprevid@svsu.edu", strPhone = "", blnIsAdmin = true },
                new User() { uidTuid = new Guid("ddaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), strSvsu_id = "500006", strFirst_name = "Devin", strLast_name = "Campbell", strEmail = "dscampbe@svsu.edu", strPhone = "", blnIsAdmin = true },
                new User() { uidTuid = new Guid("fcfaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), strSvsu_id = "500007", strFirst_name = "Durrell", strLast_name = "Pigee", strEmail = "depigee@svsu.edu", strPhone = "", blnIsAdmin = true },
                new User() { uidTuid = new Guid("cfcaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), strSvsu_id = "500008", strFirst_name = "Hunter", strLast_name = "Clipper", strEmail = "hmclippe@svsu.edu", strPhone = "", blnIsAdmin = true },
                new User() { uidTuid = new Guid("fafaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), strSvsu_id = "500009", strFirst_name = "James", strLast_name = "Hax", strEmail = "jhax@svsu.edu", strPhone = "", blnIsAdmin = true },
                new User() { uidTuid = new Guid("fffaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), strSvsu_id = "500010", strFirst_name = "Lamar", strLast_name = "Scott", strEmail = "ldscott2@svsu.edu", strPhone = "", blnIsAdmin = true },
                new User() { uidTuid = new Guid("bbbaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), strSvsu_id = "500011", strFirst_name = "Maxwell", strLast_name = "Grevais", strEmail = "mtgrevai@svsu.edu", strPhone = "", blnIsAdmin = true },
                new User() { uidTuid = new Guid("cccaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), strSvsu_id = "500012", strFirst_name = "Michael", strLast_name = "Cardinalli", strEmail = "macardin@svsu.edu", strPhone = "", blnIsAdmin = true },
                new User() { uidTuid = new Guid("cbaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), strSvsu_id = "500013", strFirst_name = "Michael", strLast_name = "Simon", strEmail = "mjsimon1@svsu.edu", strPhone = "", blnIsAdmin = true },
                new User() { uidTuid = new Guid("bcaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), strSvsu_id = "500014", strFirst_name = "Omar", strLast_name = "Salih", strEmail = "osalih@svsu.edu", strPhone = "", blnIsAdmin = true },
                new User() { uidTuid = new Guid("ccaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), strSvsu_id = "000001", strFirst_name = "Scott", strLast_name = "James", strEmail = "james@svsu.edu", strPhone = "", blnIsAdmin = true },
                new User() { uidTuid = new Guid("bbaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), strSvsu_id = "500016", strFirst_name = "Taylor", strLast_name = "Debolt", strEmail = "tsdebolt@svsu.edu", strPhone = "", blnIsAdmin = true },
                new User() { uidTuid = new Guid("baaaabaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), strSvsu_id = "500017", strFirst_name = "Trevor", strLast_name = "Eurich", strEmail = "taeurich@svsu.edu", strPhone = "", blnIsAdmin = true }
            );
